...
- ✅ **v2.1 Production Hardening** — Phases 17-22 (shipped 2026-03-20)
...
<details>
<summary>✅ v2.1 Production Hardening (Phases 17-22) — SHIPPED 2026-03-20</summary>

- [x] Phase 17: Core Routing Fixes (2/2 plans) — completed 2026-03-19
- [x] Phase 18: Usage & Tracking Fixes (2/2 plans) — completed 2026-03-19
- [x] Phase 19: Provider Cleanup (2/2 plans) — completed 2026-03-19
- [x] Phase 20: Export & Type Hygiene (2/2 plans) — completed 2026-03-19
- [x] Phase 21: Build & Docs (2/2 plans) — completed 2026-03-19
- [x] Phase 22: Async Model Wrapping (1/1 plan) — completed 2026-03-19
...
| 13-16  | v2.0      | 10/10          | Complete | 2026-03-19 |
| 17-22  | v2.1      | 11/11          | Complete | 2026-03-20 |
...
- `milestones/v2.1-ROADMAP.md` — Full v2.1 roadmap with phase details
- `milestones/v2.1-REQUIREMENTS.md` — v2.1 requirements with traceability
- `milestones/v2.1-MILESTONE-AUDIT.md` — v2.1 audit report
