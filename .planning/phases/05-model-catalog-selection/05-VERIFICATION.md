...
| `src/errors/rate-limit-error.ts`          | RateLimitError class        | ✓ VERIFIED | Extends PennyLLMError with code 'RATE_LIMITED'                                                                                         |
| `src/errors/quota-exhausted-error.ts`     | QuotaExhaustedError class   | ✓ VERIFIED | Extends PennyLLMError with code 'QUOTA_EXHAUSTED'                                                                                      |
