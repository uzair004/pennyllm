...
| -------- | ---- | ---- | ----------- | --------- | -------------------------------------------------------------------------- | ----------- | ---------- |
| 05-00-01 | 00   | 0    | ALL         | scaffold  | `npm test -- src/catalog/DefaultModelCatalog.test.ts --reporter=verbose`   | W0 creates  | ⬜ pending |
...
_Wave 0 plan: 05-00-PLAN.md creates all 4 test scaffold files. Plans 02 and 03 depend on 05-00._
