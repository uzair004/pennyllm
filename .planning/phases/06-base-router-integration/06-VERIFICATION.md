...
| `src/wrapper/router-model.ts`      | `ai`                               | `wrapLanguageModel()` to apply middleware                 | WIRED  | Line 48: `wrapLanguageModel({ model: baseModel, middleware, modelId, providerId: 'pennyllm' })`                                             |
