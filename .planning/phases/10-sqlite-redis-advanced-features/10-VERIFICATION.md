...
| 10  | All Redis keys are prefixed with configurable prefix (default: llm-router:)                                 | ✓ VERIFIED | src/redis/RedisStorage.ts line 62 sets prefix from options (default 'llm-router:'), makeKey() line 99 applies prefix          |
...
| 16  | Users can import SqliteStorage from 'llm-router/sqlite' and RedisStorage from 'llm-router/redis'            | ✓ VERIFIED | package.json lines 55-64 declare ./sqlite and ./redis subpath exports, dist outputs verified                                  |
